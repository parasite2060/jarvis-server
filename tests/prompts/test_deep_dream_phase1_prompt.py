"""Secret-handling rule presence test for deep_dream_phase1_light_sleep prompt."""

from __future__ import annotations

from pathlib import Path

PROMPT_PATH = Path(__file__).resolve().parents[2] / "prompts" / "deep_dream_phase1_light_sleep.md"
